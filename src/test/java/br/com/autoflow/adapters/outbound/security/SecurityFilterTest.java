...
import br.com.autoflow.adapters.outbound.security.SecurityFilter;
...
class SecurityFilterTest {
    ...
    void deveAutenticarQuandoTokenValido() throws ServletException, IOException {
        ...
        when(usuarioRepository.findByLogin(login)).thenReturn(Optional.of(usuarioMock));
    ...
    void naoDeveAutenticarQuandoTokenInvalido() throws ServletException, IOException {
        ...
        when(request.getHeader("Authorization")).thenReturn("Bearer " + token);
        when(tokenService.validarToken(token)).thenReturn("");
