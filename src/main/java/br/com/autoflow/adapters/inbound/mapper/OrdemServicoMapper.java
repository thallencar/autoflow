...
public interface OrdemServicoMapper {
    ...
    default HistoricoVeiculoResponse.ServicoHistorico mapearServicoHistorico(OsServico se, List<Orcamento> orcamentos) {
    ...
    default boolean isItemPertencenteAoServico(OrcamentoItem item, OsServico se) {
